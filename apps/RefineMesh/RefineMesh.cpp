...
bool Initialize(size_t argc, LPCTSTR* argv)
{
	...
	generic.add_options()
		...
		#endif
		#ifdef _USE_CUDA
		("cuda-device", boost::program_options::value(&CUDA::desiredDeviceID)->default_value(-1), "CUDA device number to be used for mesh refinement (-1 - CPU processing)")
		#endif
		;
