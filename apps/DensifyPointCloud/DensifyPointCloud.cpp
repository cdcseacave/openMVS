...
bool Initialize(size_t argc, LPCTSTR* argv)
{
	...
	config.add_options()
		...
		("sub-resolution-levels", boost::program_options::value(&nEstimationSubResolutions)->default_value(0), "number of patch-match sub-resolution iterations (0 - disabled)")
