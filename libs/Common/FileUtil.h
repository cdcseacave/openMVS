...
namespace stlplus
{
  ...
  std::vector<std::string> folder_subdirectories(const std::string& folder, bool recursive = false);
  // the set of all files
  std::vector<std::string> folder_files(const std::string& folder, bool recursive = false);
  // the set of all folders and files
  std::vector<std::string> folder_all(const std::string& folder, bool recursive = false);
