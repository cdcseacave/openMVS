...
MDEFVAR_OPTDENSE_float(fConfConfirmTau, "Conf Confirm Tau", "confidence-adjust: softness of the multi-view confirmation gate", "1.0")
...
MDEFVAR_OPTDENSE_float(fConfPhotoFloor, "Conf Photo Floor", "confidence-adjust: minimum multiplicative photometric weight", "0.3")
