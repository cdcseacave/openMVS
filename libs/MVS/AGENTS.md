...
- **Semi-Global Matching** (`SemiGlobalMatcher.h`): alternative CPU depth-map estimator to PatchMatch (`--fusion-mode -2`), multi-view hierarchical SGM over inverse-depth samples
