...
public:
	...
	// Mesh texturing
	bool TextureMesh(unsigned nResolutionLevel, unsigned nMinResolution, float fOutlierThreshold=0, bool bGlobalSeamLeveling=true, bool bLocalSeamLeveling=true, unsigned nRectPackingHeuristic=3, Pixel8U colEmpty=Pixel8U(255,127,39));
