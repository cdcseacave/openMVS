...
HRESULT CImageBMP::WriteHeader(PIXELFORMAT imageFormat, UINT width, UINT height, BYTE /*numLevels*/)
{
	...
	const BITMAPFILEHEADER bmp_fileheader = {
		0x4d42, //BM
		(DWORD)(sizeof(BITMAPFILEHEADER)+sizeof(BITMAPINFOHEADER)+m_lineWidth*m_height), //total file size
		0, 0, //reserved
		(DWORD)(sizeof(BITMAPFILEHEADER)+sizeof(BITMAPINFOHEADER)) //offset to the bitmap bits
	};
