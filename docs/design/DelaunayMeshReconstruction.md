...
(3.6 vs 5.6 GB on Courthouse) because the CGAL triangulation, ~2.4 GB there, stays resident through
the cut. Verified under ASan/UBSan on ~900k random graphs against an exact reference solver and the
